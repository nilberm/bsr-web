...
export default function Sidebar() {
  ...
  return (
    <aside className="bg-zinc-50 shadow-[4px_1px_4px_0px_rgba(0,0,0,0.25)] flex flex-col p-8 px-6 justify-between gap-4 w-80">
      <div className="h-[6%]">
      ...
      <button className="h-[4%] w-full flex justify-center items-center bg-green-500 text-zinc-50 py-5 rounded-md transition-all hover:-translate-y-1 hover:shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] active:translate-y-0 active:shadow-none">
        <FaPlus />
      </button>
    </aside>
  );
